 ...
 * easy to apply such effects without having to apply conditional logic to all buffs. */
...
namespace AKSaigyouji.Roguelike
{
    ...
    /// </summary>
    public enum EnhancementPriority
    {
        FirstAdditive = 1,
        FirstMultiplicative = 2,
        SecondAdditive = 11,
        SecondMultiplicative = 12,
        FinalAdditive = 201,
        FinalMultiplicative = 202,
        OnEvent = 244,
        Override = 255,
    } 
}